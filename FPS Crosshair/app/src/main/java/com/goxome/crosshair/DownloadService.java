    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            while ((byteread = in.read(buffer)) != -1) {
                ...
                // If the progress is equal to the previous progress, it will not be updated. If the update is too frequent, otherwise it will cause the interface to freeze
